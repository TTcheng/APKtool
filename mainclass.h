...
class MainClass : public QObject
{
    ...
    Q_PROPERTY(QList<QObject*>  procModel READ procModel  NOTIFY procModelChanged)
...
public:
    ...
    QList<QObject*> procModel(){ return pList; }
...
public:
    ...
    Q_INVOKABLE void getProcList();
    Q_INVOKABLE void sortProc(uint type);
    Q_INVOKABLE void sendSignal(uint pid, uint signal);
...
private:
    ...
    QList<QObject*> pList; //processes list
