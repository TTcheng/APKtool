...
#echo $$ > pid
/data/data/per.pqy.apktool/apktool/openjdk/bin/java -jar /data/data/per.pqy.apktool/apktool/signapk.jar /data/data/per.pqy.apktool/apktool/x509 /data/data/per.pqy.apktool/apktool/pk8 "$@" && echo "OK!"
